...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>@lang('models/infractions.singular')</h1>
                </div>
                <div class="col-sm-6">
    ...
    <div class="content px-3">
        <div class="card">
            <div class="card-body">
                {!! Form::open(['route' => 'infractions.import', 'method' => 'post', 'enctype' => 'multipart/form-data', 'onsubmit' => 'return submitForm();']) !!}
                @csrf
                ...
                <div class="card-footer">
                    ...
                    <a href="{{ route('infractions.index') }}" class="btn btn-default">
                    @lang('crud.cancel')
                    </a>
                </div>
