            ...
            <div class="card-body d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center p-4 bg-white w-100">
                ...
                <div class="mb-3 mb-sm-0">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb bg-transparent p-0 mb-2">
                            <li class="breadcrumb-item">
                                <a href="{{ route('permissions.index') }}" class="text-muted text-decoration-none small">Permissions</a>
                            </li>
                    ...
                    <h1 class="h3 font-weight-bold text-dark mb-0" style="letter-spacing: -0.5px;">
                        Modifier la permission <span class="text-primary">{{ $permission->name ?? '' }}</span>
                    </h1>
                    
                    <!-- Sous-texte -->
                    <p class="text-muted small mb-0 mt-1">
                        Ajustez les propriétés système et la description de cette règle d'accès.
                    </p>
                </div>
...
<div class="container-fluid py-5 px-md-5" style="background-color: #f8fafc; min-height: 100vh; font-family: 'Inter', system-ui, sans-serif; color: #09090b;">
    ...
    {{-- <div class="mb-5">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb bg-transparent p-0 mb-2">
                <li class="breadcrumb-item"><a href="{{ route('permissions.index') }}" class="text-muted text-decoration-none small">Permissions</a></li>
                <li class="breadcrumb-item active small text-secondary" aria-current="page">Modifier</li>
            </ol>
        </nav>
        ...
        <p class="text-muted small mb-0">Ajustez les propriétés système et la description de cette règle d'accès.</p>
    </div> --}}
    ...
    <div class="card border-0 shadow-sm rounded-xl overflow-hidden" style="border-radius: 8px; background: #ffffff; border: 1px solid #e4e4e7 !important;">
        ...
        <div class="px-4 py-4 p-md-5 border-top d-flex flex-row-reverse justify-content-start gap-3 bg-light" style="border-color: #e4e4e7 !important; background-color: #fafafa !important; gap: 12px;">
            ...
            <a href="{{ route('permissions.index') }}" class="btn btn-white text-secondary border rounded-lg px-4 py-2 font-weight-medium transition-all">
                Annuler
            </a>
        </div>
