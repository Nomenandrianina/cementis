...
<script>
    ...
    function filterCheckpoints() {
        const q = document.getElementById('checkpoint-search').value.toLowerCase().trim();
        const rows = document.querySelectorAll('.table-clean tbody tr');
        ...
        rows.forEach(row => {
            const name = row.querySelector('.cp-name')?.textContent.toLowerCase() || '';
